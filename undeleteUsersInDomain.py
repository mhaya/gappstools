...
def main():
    ...
    parser.add_argument('undelete_user_list',type=str,help='undelete user list')
    flags = parser.parse_args()
    # ドメイン名の取得
    domain_name = flags.domain_name
    undelete_user_list = flags.undelete_user_list
    ...
    for line in open(undelete_user_list,'r'):
        if len(line)==0:
            break
